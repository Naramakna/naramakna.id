    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-6">
        ...
        <div className="bg-gray-50 py-8">
          ...
          {/* Load More Button */}
          {data && data.pagination && data.pagination.hasMore && filters.limit < 350 && (
            <div className="text-center mt-8 mb-8">
              ...
              >
                {loading ? (
                  ...
                  `Tampilkan ${Math.min(50, data.pagination?.totalArticles - data.articles?.length || 0)} Lagi (${filters.limit + 50} total)`
                )}
              </button>
              <div className="text-sm text-gray-500 mt-2">
                Menampilkan {data.articles?.length || 0} dari {data.pagination?.totalArticles || 0} artikel
              </div>
            </div>
          )}

          {/* Show when reached maximum limit */}
          {data && filters.limit >= 350 && data.articles && data.articles.length >= 350 && (
            <div className="text-center mt-8 mb-8">
