            ...
            res.json({
                ...
                data: {
                    ...
                    pagination: {
                        ...
                        page: safePage,
                        limit: safeLimit,
                        total_pages: Math.ceil(users.count / safeLimit)
                    }
                }
            });
            ...
            const user = await User.findOne({
                where: {
                    [Op.or]: [
                        ...
                        // Handle dot-to-dash conversion (frontend converts dots to dashes)
                        { user_nicename: username.replace(/-/g, '.') },
                        { user_login: username.replace(/-/g, '.') },
                        { display_name: username.replace(/-/g, '.') }
                    ]
                },
        ...
        try {
            ...
            if (isAdmin) {
                ...
                if (user_role !== undefined) {
                    ...
                    if (targetUser.user_role === USER_ROLES.SUPERADMIN && currentUser.user_role !==
        ...
        try {
            ...
            const result = await Follow.findAndCountAll({
                ...
                include: [{
                    model: User,
                    as: 'follower',
                    attributes: ['ID', 'display_name', 'user_nicename', 'profile_image']
                }],
