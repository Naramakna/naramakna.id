...
echo "curl -I -H 'Origin: https://naramakna.id' '$BASE_URL/content/feed'"
curl -I -H "Origin: https://naramakna.id" "$BASE_URL/content/feed"
...
echo "curl -H 'Origin: https://naramakna.id' '$BASE_URL/content/feed' -v"